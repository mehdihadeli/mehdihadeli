...
- 🌊 [mehdihadeli/dotnet-modular-monolith-sample](https://github.com/mehdihadeli/dotnet-modular-monolith-sample): A practical modular monolith, built with .Net 7, Domain-Driven Design, CQRS, Vertical Slice Architecture, Event-Driven Architecture, and the latest technologies.
