...
- [mehdihadeli/ecommerce-modular-monolith](https://github.com/mehdihadeli/ecommerce-modular-monolith) - 🪣 A practical e-commerce modular monolith sample, built with .Net Core, Domain-Driven Design, CQRS, Vertical Slice Architecture, Event-Driven Architecture, and the latest technologies. (2 weeks ago)
...
- [FastEndpoints/FastEndpoints @ v5.1](https://github.com/FastEndpoints/FastEndpoints/releases/tag/v5.1) (2 weeks ago)
